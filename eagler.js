...
const mcHost = "iteramc.xyz";
const mcPort = 25565;
const serverName = "EternalMC";
const serverMotd = ["EternalMC", "bangkit dari kematian"];
const serverMaxPlayers = 25;
const serverOnlinePlayers = 3;
const serverPlayers = ["This server", "is Tea.VM", "compatible."];
